...
generate-go: $(CONTROLLER_GEN) $(CONVERSION_GEN) ## Runs Go related generate targets
	$(CONTROLLER_GEN) \
		...
		paths=./api/... \
		paths=./exp/cluster/api/... \
		paths=./exp/controlplane/api/...
	$(CONVERSION_GEN) \
		--input-dirs=./api/v1alpha4 \
		--input-dirs=./exp/cluster/api/v1alpha4 \
		--input-dirs=./exp/controlplane/api/v1alpha4 \
...
generate-manifests: $(CONTROLLER_GEN) ## Generate manifests e.g. CRD, RBAC etc.
	$(CONTROLLER_GEN) \
		...
		paths=./controllers/... \
		paths=./exp/cluster/api/... \
		paths=./exp/cluster/controllers/... \
		paths=./exp/controlplane/api/... \
		paths=./exp/controlplane/controllers/... \
		crd:crdVersions=v1 \
